...
1. **@Dan Wu** - 168 ms ([GitHub](https://github.com/KevinL10/applovin-query))
2. **@George Ishaq** - 269 ms ([GitHub](https://github.com/georgelshaq/Calhacks_AppLovin_Challenge))
3. **@Suprad Parashar** - 370 ms ([GitHub](https://github.com/suprad-parashar/Calhacks-12.0-Query-Planner-Challenge))
4. **@Tom Binford** - 1,134 ms
5. **@Karthik Rachamolla** - 2,010 ms ([GitHub](https://github.com/kee5625/QP_fast))
6. **@Jet** - 2,117 ms ([GitHub](https://github.com/jetpham/calhacks25))
